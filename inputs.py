...
class NmeaService:
    ...
    def _run_serial(self, kind: str) -> None:
        try:
            ...
            raise RuntimeError("pyserial is required for USB/UART NMEA") from exc
...
class TriggerService:
    ...
    def simulate(self, active: bool) -> None:
        if not self.config.get("mock"):
            raise RuntimeError("trigger simulation requires siren_trigger.mock=true")
        self._set(active)
